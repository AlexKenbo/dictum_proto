...
import 'currency.pb.dart' as $38;
import 'exchange.pb.dart' as $39;

class ListCurrenciesResponse extends $pb.GeneratedMessage {
  factory ListCurrenciesResponse({
    $core.String? resourceName,
    $core.Iterable<$38.CurrencyResponse>? currencies,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$38.CurrencyResponse>(
        2, _omitFieldNames ? '' : 'currencies', $pb.PbFieldType.PM,
        subBuilder: $38.CurrencyResponse.create)
  ...
  @$pb.TagNumber(2)
  $core.List<$38.CurrencyResponse> get currencies => $_getList(1);
}

class ListExchangesResponse extends $pb.GeneratedMessage {
  factory ListExchangesResponse({
    $core.String? resourceName,
    $core.Iterable<$39.ExchangeResponse>? exchanges,
  }) {
    final $result = create();
    if (resourceName != null) {
      $result.resourceName = resourceName;
  ...
  factory ListExchangesResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ListExchangesResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..pc<$39.ExchangeResponse>(
        2, _omitFieldNames ? '' : 'exchanges', $pb.PbFieldType.PM,
        subBuilder: $39.ExchangeResponse.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ListExchangesResponse clone() =>
      ListExchangesResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ...
  static $pb.PbList<ListExchangesResponse> createRepeated() =>
      $pb.PbList<ListExchangesResponse>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  $core.List<$39.ExchangeResponse> get exchanges => $_getList(1);
}
...
class RescheduleOrderRequest extends $pb.GeneratedMessage {
  ...
  factory RescheduleOrderRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RescheduleOrderRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RescheduleOrderRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'coincat'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  RescheduleOrderRequest clone() =>
      RescheduleOrderRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RescheduleOrderRequest copyWith(
          void Function(RescheduleOrderRequest) updates) =>
      super.copyWith((message) => updates(message as RescheduleOrderRequest))
          as RescheduleOrderRequest;
  ...
  static $pb.PbList<RescheduleOrderRequest> createRepeated() =>
      $pb.PbList<RescheduleOrderRequest>();
  @$core.pragma('dart2js:noInline')
  static RescheduleOrderRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RescheduleOrderRequest>(create);
