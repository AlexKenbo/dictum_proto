...
import '../google/protobuf/any.pb.dart' as $37;
...
class OrderRequest extends $pb.GeneratedMessage {
  ...
  factory OrderRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'OrderRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'coincat'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'email')
    ..aOS(2, _omitFieldNames ? '' : 'exchange')
    ..aOS(3, _omitFieldNames ? '' : 'sum')
    ..aOS(4, _omitFieldNames ? '' : 'desiredSumSide')
    ..m<$core.String, $core.String>(5, _omitFieldNames ? '' : 'from',
        entryClassName: 'OrderRequest.FromEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OS,
        packageName: const $pb.PackageName('coincat'))
    ..m<$core.String, $core.String>(6, _omitFieldNames ? '' : 'to',
        entryClassName: 'OrderRequest.ToEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OS,
        packageName: const $pb.PackageName('coincat'))
  ...
  static $pb.PbList<OrderRequest> createRepeated() =>
      $pb.PbList<OrderRequest>();
  @$core.pragma('dart2js:noInline')
  static OrderRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<OrderRequest>(create);
  ...
  @$pb.TagNumber(4)
  set desiredSumSide($core.String v) {
    $_setString(3, v);
  }
...
class OrderResponse extends $pb.GeneratedMessage {
  ...
  factory OrderResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory OrderResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'OrderResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'coincat'),
      createEmptyInstance: create)
    ...
    ..e<OrderStatus>(5, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE,
        defaultOrMaker: OrderStatus.NONE,
        valueOf: OrderStatus.valueOf,
        enumValues: OrderStatus.values)
    ..aOS(6, _omitFieldNames ? '' : 'accessCode')
    ..a<$core.int>(
        7, _omitFieldNames ? '' : 'amountFromUsd', $pb.PbFieldType.O3)
    ...
    ..aOM<$37.Any>(19, _omitFieldNames ? '' : 'depositTransaction',
        subBuilder: $37.Any.create)
    ..a<$core.int>(
        20, _omitFieldNames ? '' : 'requiredConfirmations', $pb.PbFieldType.O3)
    ..a<$core.int>(
        21, _omitFieldNames ? '' : 'estimatedFee', $pb.PbFieldType.O3)
    ..a<$core.int>(22, _omitFieldNames ? '' : 'estimatedProcessingTime',
        $pb.PbFieldType.O3)
    ..aOM<$37.Any>(23, _omitFieldNames ? '' : 'withdrawalExtensions',
        subBuilder: $37.Any.create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  OrderResponse copyWith(void Function(OrderResponse) updates) =>
      super.copyWith((message) => updates(message as OrderResponse))
          as OrderResponse;
  ...
  static $pb.PbList<OrderResponse> createRepeated() =>
      $pb.PbList<OrderResponse>();
  @$core.pragma('dart2js:noInline')
  static OrderResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<OrderResponse>(create);
  ...
  @$pb.TagNumber(17)
  set paymentLinkBill($core.String v) {
    $_setString(16, v);
  }
  ...
  @$pb.TagNumber(19)
  $37.Any get depositTransaction => $_getN(17);
  @$pb.TagNumber(19)
  set depositTransaction($37.Any v) {
    setField(19, v);
  }
  ...
  @$pb.TagNumber(19)
  $37.Any ensureDepositTransaction() => $_ensure(17);
  ...
  @$pb.TagNumber(22)
  set estimatedProcessingTime($core.int v) {
  ...
  @$pb.TagNumber(23)
  $37.Any get withdrawalExtensions => $_getN(21);
  @$pb.TagNumber(23)
  set withdrawalExtensions($37.Any v) {
    setField(23, v);
  }
  ...
  @$pb.TagNumber(23)
  $37.Any ensureWithdrawalExtensions() => $_ensure(21);

  @$pb.TagNumber(24)
  $core.String get currencyFrom => $_getSZ(22);
  @$pb.TagNumber(24)
  set currencyFrom($core.String v) {
    $_setString(22, v);
  }
  ...
  @$pb.TagNumber(26)
  set partnerAddress($core.String v) {
    $_setString(24, v);
  }
