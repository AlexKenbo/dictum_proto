...
class OrderResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OrderResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'coincat'), createEmptyInstance: create)
    ...
    ..aOM<$0.Any>(19, _omitFieldNames ? '' : 'depositTransaction', subBuilder: $0.Any.create)
    ...
    ..aOM<$0.Any>(23, _omitFieldNames ? '' : 'withdrawalExtensions', subBuilder: $0.Any.create)
  ...
  @$pb.TagNumber(19)
  $0.Any get depositTransaction => $_getN(17);
  @$pb.TagNumber(19)
  set depositTransaction($0.Any v) { setField(19, v); }
  @$pb.TagNumber(19)
  $core.bool hasDepositTransaction() => $_has(17);
  @$pb.TagNumber(19)
  void clearDepositTransaction() => clearField(19);
  @$pb.TagNumber(19)
  $0.Any ensureDepositTransaction() => $_ensure(17);
  ...
  @$pb.TagNumber(23)
  $0.Any get withdrawalExtensions => $_getN(21);
  @$pb.TagNumber(23)
  set withdrawalExtensions($0.Any v) { setField(23, v); }
  @$pb.TagNumber(23)
  $core.bool hasWithdrawalExtensions() => $_has(21);
  @$pb.TagNumber(23)
  void clearWithdrawalExtensions() => clearField(23);
  @$pb.TagNumber(23)
  $0.Any ensureWithdrawalExtensions() => $_ensure(21);
