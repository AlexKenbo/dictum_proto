...
class EntityRole extends $pb.GeneratedMessage {
  ...
  EntityRole._() : super();
  factory EntityRole.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory EntityRole.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'EntityRole',
      createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'userId', $pb.PbFieldType.O3)
    ..aOM<$14.Entity>(2, _omitFieldNames ? '' : 'entity',
        subBuilder: $14.Entity.create)
    ..aOS(3, _omitFieldNames ? '' : 'role')
    ..aOM<$43.Timestamp>(5, _omitFieldNames ? '' : 'hireTime',
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  EntityRole copyWith(void Function(EntityRole) updates) =>
      super.copyWith((message) => updates(message as EntityRole)) as EntityRole;
  ...
  @$core.pragma('dart2js:noInline')
  static EntityRole getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<EntityRole>(create);
  ...
  @$pb.TagNumber(2)
  $14.Entity ensureEntity() => $_ensure(1);
  ...
  @$pb.TagNumber(5)
  $43.Timestamp get hireTime => $_getN(3);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(5)
  $43.Timestamp ensureHireTime() => $_ensure(3);
}
