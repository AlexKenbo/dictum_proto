...
class EntityRole extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EntityRole', createEmptyInstance: create)
    ...
    ..aOM<$34.Timestamp>(5, _omitFieldNames ? '' : 'hireTime', subBuilder: $34.Timestamp.create)
  ...
  @$pb.TagNumber(5)
  $34.Timestamp get hireTime => $_getN(3);
  @$pb.TagNumber(5)
  set hireTime($34.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasHireTime() => $_has(3);
  @$pb.TagNumber(5)
  void clearHireTime() => clearField(5);
  @$pb.TagNumber(5)
  $34.Timestamp ensureHireTime() => $_ensure(3);
}
