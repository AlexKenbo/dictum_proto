...
class Employee extends $pb.GeneratedMessage {
  factory Employee({
    ...
    $3.Entity? entity,
    $38.Country? country,
    $36.Timestamp? hireTime,
    $36.Timestamp? unhireTime,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Employee', createEmptyInstance: create)
    ...
    ..e<$45.Role>(4, _omitFieldNames ? '' : 'role', $pb.PbFieldType.OE, defaultOrMaker: $45.Role.ROLE_UNKNOWN, valueOf: $45.Role.valueOf, enumValues: $45.Role.values)
    ...
    ..aOM<$38.Country>(15, _omitFieldNames ? '' : 'country', subBuilder: $38.Country.create)
    ..aOM<$36.Timestamp>(16, _omitFieldNames ? '' : 'hireTime', subBuilder: $36.Timestamp.create)
    ..aOM<$36.Timestamp>(17, _omitFieldNames ? '' : 'unhireTime', subBuilder: $36.Timestamp.create)
    ..pc<$25.Permission>(18, _omitFieldNames ? '' : 'permissions', $pb.PbFieldType.PM, subBuilder: $25.Permission.create)
  ...
  @$pb.TagNumber(4)
  $45.Role get role => $_getN(2);
  @$pb.TagNumber(4)
  set role($45.Role v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(15)
  $38.Country get country => $_getN(6);
  @$pb.TagNumber(15)
  set country($38.Country v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasCountry() => $_has(6);
  @$pb.TagNumber(15)
  void clearCountry() => clearField(15);
  @$pb.TagNumber(15)
  $38.Country ensureCountry() => $_ensure(6);

  @$pb.TagNumber(16)
  $36.Timestamp get hireTime => $_getN(7);
  @$pb.TagNumber(16)
  set hireTime($36.Timestamp v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasHireTime() => $_has(7);
  @$pb.TagNumber(16)
  void clearHireTime() => clearField(16);
  @$pb.TagNumber(16)
  $36.Timestamp ensureHireTime() => $_ensure(7);

  @$pb.TagNumber(17)
  $36.Timestamp get unhireTime => $_getN(8);
  @$pb.TagNumber(17)
  set unhireTime($36.Timestamp v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasUnhireTime() => $_has(8);
  @$pb.TagNumber(17)
  void clearUnhireTime() => clearField(17);
  @$pb.TagNumber(17)
  $36.Timestamp ensureUnhireTime() => $_ensure(8);

  /// New invoicing
  @$pb.TagNumber(18)
  $core.List<$25.Permission> get permissions => $_getList(9);
}
