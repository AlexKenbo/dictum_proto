...
class ObjectSource extends $pb.GeneratedMessage {
  ...
  factory ObjectSource.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ObjectSource.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ObjectSource',
    ...
    ..aOM<$43.Timestamp>(7, _omitFieldNames ? '' : 'createTime',
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  ObjectSource copyWith(void Function(ObjectSource) updates) =>
      super.copyWith((message) => updates(message as ObjectSource))
          as ObjectSource;
  ...
  static $pb.PbList<ObjectSource> createRepeated() =>
      $pb.PbList<ObjectSource>();
  @$core.pragma('dart2js:noInline')
  static ObjectSource getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ObjectSource>(create);
  ...
  @$pb.TagNumber(6)
  $34.Service get service => $_getN(4);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(6)
  $34.Service ensureService() => $_ensure(4);

  @$pb.TagNumber(7)
  $43.Timestamp get createTime => $_getN(5);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(7)
  $43.Timestamp ensureCreateTime() => $_ensure(5);
}
