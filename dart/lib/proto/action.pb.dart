...
import 'action_type.pbenum.dart' as $40;
...
class Action extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Action', createEmptyInstance: create)
    ...
    ..e<$40.ActionType>(2, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $40.ActionType.ACTION_TYPE_UNKNOWN, valueOf: $40.ActionType.valueOf, enumValues: $40.ActionType.values)
  ...
  @$pb.TagNumber(2)
  $40.ActionType get type => $_getN(1);
  @$pb.TagNumber(2)
  set type($40.ActionType v) { setField(2, v); }
  @$pb.TagNumber(2)
