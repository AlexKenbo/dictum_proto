...
class EntityArticle extends $pb.GeneratedMessage {
  ...
  factory EntityArticle.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory EntityArticle.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'EntityArticle',
      createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'articleId', $pb.PbFieldType.O3)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'entityId', $pb.PbFieldType.O3)
    ..aOM<$31.Article>(3, _omitFieldNames ? '' : 'article',
        subBuilder: $31.Article.create)
    ..aOM<$14.Entity>(5, _omitFieldNames ? '' : 'entity',
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  EntityArticle copyWith(void Function(EntityArticle) updates) =>
      super.copyWith((message) => updates(message as EntityArticle))
          as EntityArticle;
  ...
  static $pb.PbList<EntityArticle> createRepeated() =>
      $pb.PbList<EntityArticle>();
  @$core.pragma('dart2js:noInline')
  static EntityArticle getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<EntityArticle>(create);
