...
class EntityArticle extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EntityArticle', createEmptyInstance: create)
    ...
    ..aOM<$26.Article>(3, _omitFieldNames ? '' : 'article', subBuilder: $26.Article.create)
  ...
  @$pb.TagNumber(3)
  $26.Article get article => $_getN(2);
  @$pb.TagNumber(3)
  set article($26.Article v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasArticle() => $_has(2);
  @$pb.TagNumber(3)
  void clearArticle() => clearField(3);
  @$pb.TagNumber(3)
  $26.Article ensureArticle() => $_ensure(2);
