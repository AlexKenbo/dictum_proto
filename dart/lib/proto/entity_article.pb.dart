...
class EntityArticle extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EntityArticle', createEmptyInstance: create)
    ...
    ..aOM<$0.Article>(3, _omitFieldNames ? '' : 'article', subBuilder: $0.Article.create)
    ..aOM<$1.Entity>(5, _omitFieldNames ? '' : 'entity', subBuilder: $1.Entity.create)
  ...
  @$pb.TagNumber(3)
  $0.Article get article => $_getN(2);
  @$pb.TagNumber(3)
  set article($0.Article v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasArticle() => $_has(2);
  @$pb.TagNumber(3)
  void clearArticle() => clearField(3);
  @$pb.TagNumber(3)
  $0.Article ensureArticle() => $_ensure(2);

  @$pb.TagNumber(5)
  $1.Entity get entity => $_getN(3);
  @$pb.TagNumber(5)
  set entity($1.Entity v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasEntity() => $_has(3);
  @$pb.TagNumber(5)
  void clearEntity() => clearField(5);
  @$pb.TagNumber(5)
  $1.Entity ensureEntity() => $_ensure(3);
}
