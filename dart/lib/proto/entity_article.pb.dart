...
class EntityArticle extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EntityArticle', createEmptyInstance: create)
    ...
    ..aOM<$28.Article>(3, _omitFieldNames ? '' : 'article', subBuilder: $28.Article.create)
  ...
  @$pb.TagNumber(3)
  $28.Article get article => $_getN(2);
  @$pb.TagNumber(3)
  set article($28.Article v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasArticle() => $_has(2);
  @$pb.TagNumber(3)
  void clearArticle() => clearField(3);
  @$pb.TagNumber(3)
  $28.Article ensureArticle() => $_ensure(2);
