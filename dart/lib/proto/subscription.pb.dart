...
class Subscription extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.int>(
        1, _omitFieldNames ? '' : 'subscriptionId', $pb.PbFieldType.O3)
    ..e<$68.OperationType>(
        3, _omitFieldNames ? '' : 'operationType', $pb.PbFieldType.OE,
        defaultOrMaker: $68.OperationType.OPERATION_TYPE_UNKNOWN,
        valueOf: $68.OperationType.valueOf,
        enumValues: $68.OperationType.values)
  ...
  @$pb.TagNumber(3)
  set operationType($68.OperationType v) {
    setField(3, v);
  }
