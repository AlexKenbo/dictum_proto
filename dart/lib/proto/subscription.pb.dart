...
import 'operation_type.pbenum.dart' as $71;
...
class Subscription extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Subscription', createEmptyInstance: create)
    ...
    ..e<$71.OperationType>(3, _omitFieldNames ? '' : 'operationType', $pb.PbFieldType.OE, defaultOrMaker: $71.OperationType.OPERATION_TYPE_UNKNOWN, valueOf: $71.OperationType.valueOf, enumValues: $71.OperationType.values)
  ...
  @$pb.TagNumber(3)
  $71.OperationType get operationType => $_getN(1);
  @$pb.TagNumber(3)
  set operationType($71.OperationType v) { setField(3, v); }
  @$pb.TagNumber(3)
