...
class TelegramUserChat extends $pb.GeneratedMessage {
  ...
  factory TelegramUserChat.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TelegramUserChat.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TelegramUserChat',
      createEmptyInstance: create)
    ..a<$core.int>(
        1, _omitFieldNames ? '' : 'telegramUserChatId', $pb.PbFieldType.O3)
    ..a<$core.int>(
        2, _omitFieldNames ? '' : 'chatSourceKey', $pb.PbFieldType.O3)
    ..a<$core.int>(
        3, _omitFieldNames ? '' : 'telegramUserId', $pb.PbFieldType.O3)
    ..aOM<$44.TelegramUser>(4, _omitFieldNames ? '' : 'telegramUser',
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  TelegramUserChat copyWith(void Function(TelegramUserChat) updates) =>
      super.copyWith((message) => updates(message as TelegramUserChat))
          as TelegramUserChat;
  ...
  static $pb.PbList<TelegramUserChat> createRepeated() =>
      $pb.PbList<TelegramUserChat>();
  @$core.pragma('dart2js:noInline')
  static TelegramUserChat getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TelegramUserChat>(create);
  static TelegramUserChat? _defaultInstance;

  @$pb.TagNumber(1)
  $core.int get telegramUserChatId => $_getIZ(0);
  @$pb.TagNumber(1)
  set telegramUserChatId($core.int v) {
    $_setSignedInt32(0, v);
  }
