...
class AccrualMirrorState extends $pb.GeneratedMessage {
  ...
  factory AccrualMirrorState.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AccrualMirrorState.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AccrualMirrorState',
      createEmptyInstance: create)
    ..a<$core.int>(
        1, _omitFieldNames ? '' : 'accrualMirrorStateId', $pb.PbFieldType.O3)
    ..e<$40.PaymentType>(
        2, _omitFieldNames ? '' : 'paymentType', $pb.PbFieldType.OE,
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  AccrualMirrorState copyWith(void Function(AccrualMirrorState) updates) =>
      super.copyWith((message) => updates(message as AccrualMirrorState))
          as AccrualMirrorState;
  ...
  static $pb.PbList<AccrualMirrorState> createRepeated() =>
      $pb.PbList<AccrualMirrorState>();
  @$core.pragma('dart2js:noInline')
  static AccrualMirrorState getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AccrualMirrorState>(create);
  static AccrualMirrorState? _defaultInstance;

  @$pb.TagNumber(1)
  $core.int get accrualMirrorStateId => $_getIZ(0);
  @$pb.TagNumber(1)
  set accrualMirrorStateId($core.int v) {
    $_setSignedInt32(0, v);
  }
  ...
  @$pb.TagNumber(2)
  $40.PaymentType get paymentType => $_getN(1);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  set sellerStatus($core.String v) {
    $_setString(3, v);
  }
  ...
  @$pb.TagNumber(8)
  set sellerAction($core.String v) {
    $_setString(6, v);
  }
