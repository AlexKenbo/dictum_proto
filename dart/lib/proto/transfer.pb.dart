...
class Transfer extends $pb.GeneratedMessage {
  factory Transfer({
    ...
    $2.Account? payerAccount,
    $2.Account? recipientAccount,
    $3.Entity? payer,
    $3.Entity? recipient,
    $0.Event? parentEvent,
  }) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Transfer', createEmptyInstance: create)
    ...
    ..aOM<$1.User>(28, _omitFieldNames ? '' : 'verifier', subBuilder: $1.User.create)
    ...
    ..aInt64(46, _omitFieldNames ? '' : 'fullAllocationTime')
    ..aOM<$2.Account>(47, _omitFieldNames ? '' : 'payerAccount', subBuilder: $2.Account.create)
    ..aOM<$2.Account>(48, _omitFieldNames ? '' : 'recipientAccount', subBuilder: $2.Account.create)
    ..aOM<$3.Entity>(49, _omitFieldNames ? '' : 'payer', subBuilder: $3.Entity.create)
    ..aOM<$3.Entity>(50, _omitFieldNames ? '' : 'recipient', subBuilder: $3.Entity.create)
    ..aOM<$0.Event>(51, _omitFieldNames ? '' : 'parentEvent', subBuilder: $0.Event.create)
  ...
  @$pb.TagNumber(22)
  $4.TransferType get type => $_getN(13);
  @$pb.TagNumber(22)
  ...
  @$pb.TagNumber(28)
  $1.User get verifier => $_getN(15);
  @$pb.TagNumber(28)
  set verifier($1.User v) { setField(28, v); }
  @$pb.TagNumber(28)
  $core.bool hasVerifier() => $_has(15);
  @$pb.TagNumber(28)
  void clearVerifier() => clearField(28);
  @$pb.TagNumber(28)
  $1.User ensureVerifier() => $_ensure(15);

  @$pb.TagNumber(31)
  $core.int get payerId => $_getIZ(16);
  @$pb.TagNumber(31)
  set payerId($core.int v) { $_setSignedInt32(16, v); }
  @$pb.TagNumber(31)
  $core.bool hasPayerId() => $_has(16);
  @$pb.TagNumber(31)
  void clearPayerId() => clearField(31);

  @$pb.TagNumber(32)
  $core.int get payerAccountId => $_getIZ(17);
  @$pb.TagNumber(32)
  set payerAccountId($core.int v) { $_setSignedInt32(17, v); }
  @$pb.TagNumber(32)
  $core.bool hasPayerAccountId() => $_has(17);
  @$pb.TagNumber(32)
  void clearPayerAccountId() => clearField(32);

  @$pb.TagNumber(33)
  $core.String get payerTransferKey => $_getSZ(18);
  @$pb.TagNumber(33)
  set payerTransferKey($core.String v) { $_setString(18, v); }
  @$pb.TagNumber(33)
  $core.bool hasPayerTransferKey() => $_has(18);
  @$pb.TagNumber(33)
  void clearPayerTransferKey() => clearField(33);

  @$pb.TagNumber(34)
  $core.int get recipientId => $_getIZ(19);
  @$pb.TagNumber(34)
  set recipientId($core.int v) { $_setSignedInt32(19, v); }
  @$pb.TagNumber(34)
  $core.bool hasRecipientId() => $_has(19);
  @$pb.TagNumber(34)
  void clearRecipientId() => clearField(34);

  @$pb.TagNumber(35)
  $core.int get recipientAccountId => $_getIZ(20);
  @$pb.TagNumber(35)
  set recipientAccountId($core.int v) { $_setSignedInt32(20, v); }
  @$pb.TagNumber(35)
  ...
  @$pb.TagNumber(36)
  $core.String get recipientTransferKey => $_getSZ(21);
  @$pb.TagNumber(36)
  set recipientTransferKey($core.String v) { $_setString(21, v); }
  @$pb.TagNumber(36)
  $core.bool hasRecipientTransferKey() => $_has(21);
  @$pb.TagNumber(36)
  void clearRecipientTransferKey() => clearField(36);

  @$pb.TagNumber(37)
  $core.double get amount => $_getN(22);
  @$pb.TagNumber(37)
  set amount($core.double v) { $_setDouble(22, v); }
  @$pb.TagNumber(37)
  $core.bool hasAmount() => $_has(22);
  @$pb.TagNumber(37)
  void clearAmount() => clearField(37);

  @$pb.TagNumber(38)
  $core.double get allocatedAmount => $_getN(23);
  @$pb.TagNumber(38)
  set allocatedAmount($core.double v) { $_setDouble(23, v); }
  @$pb.TagNumber(38)
  $core.bool hasAllocatedAmount() => $_has(23);
  @$pb.TagNumber(38)
  void clearAllocatedAmount() => clearField(38);

  @$pb.TagNumber(40)
  $core.int get parentId => $_getIZ(24);
  @$pb.TagNumber(40)
  set parentId($core.int v) { $_setSignedInt32(24, v); }
  @$pb.TagNumber(40)
  ...
  @$pb.TagNumber(42)
  $5.Source get datasource => $_getN(25);
  @$pb.TagNumber(42)
  set datasource($5.Source v) { setField(42, v); }
  @$pb.TagNumber(42)
  $core.bool hasDatasource() => $_has(25);
  @$pb.TagNumber(42)
  void clearDatasource() => clearField(42);

  @$pb.TagNumber(43)
  $6.Color get color => $_getN(26);
  @$pb.TagNumber(43)
  set color($6.Color v) { setField(43, v); }
  @$pb.TagNumber(43)
  $core.bool hasColor() => $_has(26);
  @$pb.TagNumber(43)
  void clearColor() => clearField(43);

  @$pb.TagNumber(44)
  $core.String get note => $_getSZ(27);
  @$pb.TagNumber(44)
  set note($core.String v) { $_setString(27, v); }
  @$pb.TagNumber(44)
  $core.bool hasNote() => $_has(27);
  @$pb.TagNumber(44)
  void clearNote() => clearField(44);

  @$pb.TagNumber(45)
  $fixnum.Int64 get createTime => $_getI64(28);
  @$pb.TagNumber(45)
  set createTime($fixnum.Int64 v) { $_setInt64(28, v); }
  @$pb.TagNumber(45)
  $core.bool hasCreateTime() => $_has(28);
  @$pb.TagNumber(45)
  void clearCreateTime() => clearField(45);

  @$pb.TagNumber(46)
  $fixnum.Int64 get fullAllocationTime => $_getI64(29);
  @$pb.TagNumber(46)
  set fullAllocationTime($fixnum.Int64 v) { $_setInt64(29, v); }
  @$pb.TagNumber(46)
  $core.bool hasFullAllocationTime() => $_has(29);
  @$pb.TagNumber(46)
  void clearFullAllocationTime() => clearField(46);

  @$pb.TagNumber(47)
  $2.Account get payerAccount => $_getN(30);
  @$pb.TagNumber(47)
  set payerAccount($2.Account v) { setField(47, v); }
  @$pb.TagNumber(47)
  $core.bool hasPayerAccount() => $_has(30);
  @$pb.TagNumber(47)
  void clearPayerAccount() => clearField(47);
  @$pb.TagNumber(47)
  $2.Account ensurePayerAccount() => $_ensure(30);

  @$pb.TagNumber(48)
  $2.Account get recipientAccount => $_getN(31);
  @$pb.TagNumber(48)
  set recipientAccount($2.Account v) { setField(48, v); }
  @$pb.TagNumber(48)
  $core.bool hasRecipientAccount() => $_has(31);
  @$pb.TagNumber(48)
  void clearRecipientAccount() => clearField(48);
  @$pb.TagNumber(48)
  $2.Account ensureRecipientAccount() => $_ensure(31);

  @$pb.TagNumber(49)
  $3.Entity get payer => $_getN(32);
  @$pb.TagNumber(49)
  set payer($3.Entity v) { setField(49, v); }
  @$pb.TagNumber(49)
  $core.bool hasPayer() => $_has(32);
  @$pb.TagNumber(49)
  void clearPayer() => clearField(49);
  @$pb.TagNumber(49)
  $3.Entity ensurePayer() => $_ensure(32);

  @$pb.TagNumber(50)
  $3.Entity get recipient => $_getN(33);
  @$pb.TagNumber(50)
  set recipient($3.Entity v) { setField(50, v); }
  @$pb.TagNumber(50)
  $core.bool hasRecipient() => $_has(33);
  @$pb.TagNumber(50)
  void clearRecipient() => clearField(50);
  @$pb.TagNumber(50)
  $3.Entity ensureRecipient() => $_ensure(33);

  @$pb.TagNumber(51)
  $0.Event get parentEvent => $_getN(34);
  @$pb.TagNumber(51)
  set parentEvent($0.Event v) { setField(51, v); }
  @$pb.TagNumber(51)
  $core.bool hasParentEvent() => $_has(34);
  @$pb.TagNumber(51)
  void clearParentEvent() => clearField(51);
  @$pb.TagNumber(51)
  $0.Event ensureParentEvent() => $_ensure(34);
}
