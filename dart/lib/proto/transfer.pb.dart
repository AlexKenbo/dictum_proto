...
class Transfer extends $pb.GeneratedMessage {
  factory Transfer({
    ...
    $43.Timestamp? paymentTime,
    $43.Timestamp? verifyTime,
    Transfer? parent,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$65.TransferType>(22, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE,
        defaultOrMaker: $65.TransferType.TRANSFER_TYPE_UNKNOWN,
        valueOf: $65.TransferType.valueOf,
        enumValues: $65.TransferType.values)
    ..aOM<$11.User>(28, _omitFieldNames ? '' : 'verifier',
        subBuilder: $11.User.create)
    ..a<$core.int>(31, _omitFieldNames ? '' : 'payerId', $pb.PbFieldType.O3)
    ..a<$core.int>(
        32, _omitFieldNames ? '' : 'payerAccountId', $pb.PbFieldType.O3)
    ..aOS(33, _omitFieldNames ? '' : 'payerTransferKey')
    ..a<$core.int>(34, _omitFieldNames ? '' : 'recipientId', $pb.PbFieldType.O3)
    ..a<$core.int>(
        35, _omitFieldNames ? '' : 'recipientAccountId', $pb.PbFieldType.O3)
    ..aOS(36, _omitFieldNames ? '' : 'recipientTransferKey')
    ..a<$core.double>(37, _omitFieldNames ? '' : 'amount', $pb.PbFieldType.OD)
    ..a<$core.double>(
        38, _omitFieldNames ? '' : 'allocatedAmount', $pb.PbFieldType.OD)
    ..a<$core.int>(40, _omitFieldNames ? '' : 'parentId', $pb.PbFieldType.O3)
    ..e<$62.Source>(42, _omitFieldNames ? '' : 'datasource', $pb.PbFieldType.OE,
        defaultOrMaker: $62.Source.SOURCE_UNKNOWN,
        valueOf: $62.Source.valueOf,
        enumValues: $62.Source.values)
    ..e<$63.Color>(43, _omitFieldNames ? '' : 'color', $pb.PbFieldType.OE,
        defaultOrMaker: $63.Color.COLOR_UNKNOWN,
        valueOf: $63.Color.valueOf,
        enumValues: $63.Color.values)
    ..aOS(44, _omitFieldNames ? '' : 'note')
    ..aOM<$18.Account>(47, _omitFieldNames ? '' : 'payerAccount',
        subBuilder: $18.Account.create)
    ..aOM<$18.Account>(48, _omitFieldNames ? '' : 'recipientAccount',
        subBuilder: $18.Account.create)
    ..aOM<$14.Entity>(49, _omitFieldNames ? '' : 'payer',
        subBuilder: $14.Entity.create)
    ..aOM<$14.Entity>(50, _omitFieldNames ? '' : 'recipient',
        subBuilder: $14.Entity.create)
    ..aOM<$43.Timestamp>(52, _omitFieldNames ? '' : 'createTime',
        subBuilder: $43.Timestamp.create)
    ..aOM<$43.Timestamp>(53, _omitFieldNames ? '' : 'fullAllocationTime',
        subBuilder: $43.Timestamp.create)
    ..aOM<$43.Timestamp>(54, _omitFieldNames ? '' : 'paymentTime',
        subBuilder: $43.Timestamp.create)
    ..aOM<$43.Timestamp>(55, _omitFieldNames ? '' : 'verifyTime',
        subBuilder: $43.Timestamp.create)
    ..aOM<Transfer>(56, _omitFieldNames ? '' : 'parent',
        subBuilder: Transfer.create)
    ..aOS(57, _omitFieldNames ? '' : 'recipientCurrencyCode')
    ..pc<$4.Attachment>(
        58, _omitFieldNames ? '' : 'attachments', $pb.PbFieldType.PM,
        subBuilder: $4.Attachment.create)
    ..aOS(59, _omitFieldNames ? '' : 'payerAccountNumber')
    ..aOS(60, _omitFieldNames ? '' : 'recipientAccountNumber')
    ..a<$core.double>(
        61, _omitFieldNames ? '' : 'payerAmount', $pb.PbFieldType.OD)
    ..a<$core.double>(
        62, _omitFieldNames ? '' : 'recipientAmount', $pb.PbFieldType.OD)
    ..aOS(63, _omitFieldNames ? '' : 'payerCurrencyCode')
    ..aOS(64, _omitFieldNames ? '' : 'externalUrl')
    ..e<$64.Status>(65, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE,
  ...
  @$pb.TagNumber(10)
  set paymentPurpose($core.String v) {
    $_setString(3, v);
  }
  ...
  @$pb.TagNumber(33)
  set payerTransferKey($core.String v) {
    $_setString(11, v);
  }
  ...
  @$pb.TagNumber(36)
  set recipientTransferKey($core.String v) {
    $_setString(14, v);
  }
  ...
  @$pb.TagNumber(52)
  $43.Timestamp get createTime => $_getN(25);
  @$pb.TagNumber(52)
  ...
  @$pb.TagNumber(52)
  $43.Timestamp ensureCreateTime() => $_ensure(25);

  @$pb.TagNumber(53)
  $43.Timestamp get fullAllocationTime => $_getN(26);
  @$pb.TagNumber(53)
  ...
  @$pb.TagNumber(53)
  $43.Timestamp ensureFullAllocationTime() => $_ensure(26);

  @$pb.TagNumber(54)
  $43.Timestamp get paymentTime => $_getN(27);
  @$pb.TagNumber(54)
  set paymentTime($43.Timestamp v) {
    setField(54, v);
  }
  ...
  @$pb.TagNumber(54)
  $43.Timestamp ensurePaymentTime() => $_ensure(27);

  @$pb.TagNumber(55)
  $43.Timestamp get verifyTime => $_getN(28);
  @$pb.TagNumber(55)
  set verifyTime($43.Timestamp v) {
    setField(55, v);
  }
  ...
  @$pb.TagNumber(55)
  $43.Timestamp ensureVerifyTime() => $_ensure(28);

  @$pb.TagNumber(56)
  Transfer get parent => $_getN(29);
  @$pb.TagNumber(56)
  set parent(Transfer v) {
    setField(56, v);
  }
  ...
  @$pb.TagNumber(57)
  set recipientCurrencyCode($core.String v) {
    $_setString(30, v);
  }
  ...
  @$pb.TagNumber(59)
  set payerAccountNumber($core.String v) {
    $_setString(32, v);
  }
  ...
  @$pb.TagNumber(60)
  set recipientAccountNumber($core.String v) {
    $_setString(33, v);
  }
  ...
  @$pb.TagNumber(62)
  set recipientAmount($core.double v) {
    $_setDouble(35, v);
  }
  ...
  @$pb.TagNumber(63)
  set payerCurrencyCode($core.String v) {
    $_setString(36, v);
  }
