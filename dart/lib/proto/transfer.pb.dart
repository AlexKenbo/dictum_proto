...
import 'transfer_type.pbenum.dart' as $44;
...
class Transfer extends $pb.GeneratedMessage {
  factory Transfer({
    ...
    $31.Timestamp? paymentTime,
    $31.Timestamp? verifyTime,
    Transfer? parent,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Transfer', createEmptyInstance: create)
    ...
    ..e<$44.TransferType>(22, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $44.TransferType.TRANSFER_TYPE_UNKNOWN, valueOf: $44.TransferType.valueOf, enumValues: $44.TransferType.values)
    ...
    ..e<$45.Source>(42, _omitFieldNames ? '' : 'datasource', $pb.PbFieldType.OE, defaultOrMaker: $45.Source.SOURCE_UNKNOWN, valueOf: $45.Source.valueOf, enumValues: $45.Source.values)
    ..e<$46.Color>(43, _omitFieldNames ? '' : 'color', $pb.PbFieldType.OE, defaultOrMaker: $46.Color.COLOR_UNKNOWN, valueOf: $46.Color.valueOf, enumValues: $46.Color.values)
    ...
    ..aOM<$31.Timestamp>(52, _omitFieldNames ? '' : 'createTime', subBuilder: $31.Timestamp.create)
    ..aOM<$31.Timestamp>(53, _omitFieldNames ? '' : 'fullAllocationTime', subBuilder: $31.Timestamp.create)
    ..aOM<$31.Timestamp>(54, _omitFieldNames ? '' : 'paymentTime', subBuilder: $31.Timestamp.create)
    ..aOM<$31.Timestamp>(55, _omitFieldNames ? '' : 'verifyTime', subBuilder: $31.Timestamp.create)
    ...
    ..e<$47.Status>(65, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $47.Status.STATUS_UNSPECIFIED, valueOf: $47.Status.valueOf, enumValues: $47.Status.values)
  ...
  @$pb.TagNumber(22)
  $44.TransferType get type => $_getN(7);
  @$pb.TagNumber(22)
  set type($44.TransferType v) { setField(22, v); }
  @$pb.TagNumber(22)
  ...
  @$pb.TagNumber(28)
  $13.User get verifier => $_getN(8);
  @$pb.TagNumber(28)
  set verifier($13.User v) { setField(28, v); }
  @$pb.TagNumber(28)
  $core.bool hasVerifier() => $_has(8);
  @$pb.TagNumber(28)
  void clearVerifier() => clearField(28);
  @$pb.TagNumber(28)
  $13.User ensureVerifier() => $_ensure(8);
  ...
  @$pb.TagNumber(42)
  $45.Source get datasource => $_getN(18);
  @$pb.TagNumber(42)
  set datasource($45.Source v) { setField(42, v); }
  @$pb.TagNumber(42)
  ...
  @$pb.TagNumber(43)
  $46.Color get color => $_getN(19);
  @$pb.TagNumber(43)
  set color($46.Color v) { setField(43, v); }
  @$pb.TagNumber(43)
  ...
  @$pb.TagNumber(47)
  $6.Account get payerAccount => $_getN(21);
  @$pb.TagNumber(47)
  set payerAccount($6.Account v) { setField(47, v); }
  @$pb.TagNumber(47)
  $core.bool hasPayerAccount() => $_has(21);
  @$pb.TagNumber(47)
  void clearPayerAccount() => clearField(47);
  @$pb.TagNumber(47)
  $6.Account ensurePayerAccount() => $_ensure(21);

  @$pb.TagNumber(48)
  $6.Account get recipientAccount => $_getN(22);
  @$pb.TagNumber(48)
  set recipientAccount($6.Account v) { setField(48, v); }
  @$pb.TagNumber(48)
  $core.bool hasRecipientAccount() => $_has(22);
  @$pb.TagNumber(48)
  void clearRecipientAccount() => clearField(48);
  @$pb.TagNumber(48)
  $6.Account ensureRecipientAccount() => $_ensure(22);
  ...
  @$pb.TagNumber(52)
  $31.Timestamp get createTime => $_getN(25);
  @$pb.TagNumber(52)
  set createTime($31.Timestamp v) { setField(52, v); }
  @$pb.TagNumber(52)
  $core.bool hasCreateTime() => $_has(25);
  @$pb.TagNumber(52)
  void clearCreateTime() => clearField(52);
  @$pb.TagNumber(52)
  $31.Timestamp ensureCreateTime() => $_ensure(25);

  @$pb.TagNumber(53)
  $31.Timestamp get fullAllocationTime => $_getN(26);
  @$pb.TagNumber(53)
  set fullAllocationTime($31.Timestamp v) { setField(53, v); }
  @$pb.TagNumber(53)
  $core.bool hasFullAllocationTime() => $_has(26);
  @$pb.TagNumber(53)
  void clearFullAllocationTime() => clearField(53);
  @$pb.TagNumber(53)
  $31.Timestamp ensureFullAllocationTime() => $_ensure(26);

  @$pb.TagNumber(54)
  $31.Timestamp get paymentTime => $_getN(27);
  @$pb.TagNumber(54)
  set paymentTime($31.Timestamp v) { setField(54, v); }
  @$pb.TagNumber(54)
  $core.bool hasPaymentTime() => $_has(27);
  @$pb.TagNumber(54)
  void clearPaymentTime() => clearField(54);
  @$pb.TagNumber(54)
  $31.Timestamp ensurePaymentTime() => $_ensure(27);

  @$pb.TagNumber(55)
  $31.Timestamp get verifyTime => $_getN(28);
  @$pb.TagNumber(55)
  set verifyTime($31.Timestamp v) { setField(55, v); }
  @$pb.TagNumber(55)
  $core.bool hasVerifyTime() => $_has(28);
  @$pb.TagNumber(55)
  void clearVerifyTime() => clearField(55);
  @$pb.TagNumber(55)
  $31.Timestamp ensureVerifyTime() => $_ensure(28);
  ...
  @$pb.TagNumber(65)
  $47.Status get status => $_getN(37);
  @$pb.TagNumber(65)
  set status($47.Status v) { setField(65, v); }
  @$pb.TagNumber(65)
