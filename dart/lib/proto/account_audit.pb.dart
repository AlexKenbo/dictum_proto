...
class AccountAudit extends $pb.GeneratedMessage {
  ...
  factory AccountAudit.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AccountAudit.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AccountAudit',
    ...
    ..a<$core.double>(
        6, _omitFieldNames ? '' : 'currentBalance', $pb.PbFieldType.OD)
    ..aOS(7, _omitFieldNames ? '' : 'resourceName')
    ..a<$core.double>(
        8, _omitFieldNames ? '' : 'unverifiedBalance', $pb.PbFieldType.OD)
    ..aOM<$18.Account>(9, _omitFieldNames ? '' : 'account',
        subBuilder: $18.Account.create)
    ..a<$core.double>(
        10, _omitFieldNames ? '' : 'bankBalance', $pb.PbFieldType.OD)
    ..aOB(13, _omitFieldNames ? '' : 'balanceCorrect')
    ..aOM<$43.Timestamp>(14, _omitFieldNames ? '' : 'createTime',
        subBuilder: $43.Timestamp.create)
    ..aOM<$11.User>(15, _omitFieldNames ? '' : 'auditor',
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  AccountAudit copyWith(void Function(AccountAudit) updates) =>
      super.copyWith((message) => updates(message as AccountAudit))
          as AccountAudit;
  ...
  static $pb.PbList<AccountAudit> createRepeated() =>
      $pb.PbList<AccountAudit>();
  @$core.pragma('dart2js:noInline')
  static AccountAudit getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AccountAudit>(create);
  ...
  @$pb.TagNumber(8)
  set unverifiedBalance($core.double v) {
    $_setDouble(5, v);
  }
  ...
  @$pb.TagNumber(9)
  $18.Account get account => $_getN(6);
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(9)
  $18.Account ensureAccount() => $_ensure(6);

  @$pb.TagNumber(10)
  $core.double get bankBalance => $_getN(7);
  @$pb.TagNumber(10)
  set bankBalance($core.double v) {
    $_setDouble(7, v);
  }
  ...
  @$pb.TagNumber(13)
  set balanceCorrect($core.bool v) {
    $_setBool(8, v);
  }
  ...
  @$pb.TagNumber(15)
  $11.User get auditor => $_getN(10);
  @$pb.TagNumber(15)
  set auditor($11.User v) {
    setField(15, v);
  }
  ...
  @$pb.TagNumber(15)
  $11.User ensureAuditor() => $_ensure(10);
}
