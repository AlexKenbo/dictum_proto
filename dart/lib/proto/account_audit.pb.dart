...
class AccountAudit extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccountAudit', createEmptyInstance: create)
    ...
    ..aOM<$34.Timestamp>(12, _omitFieldNames ? '' : 'auditTime', subBuilder: $34.Timestamp.create)
  ...
  @$pb.TagNumber(12)
  $34.Timestamp get auditTime => $_getN(7);
  @$pb.TagNumber(12)
  set auditTime($34.Timestamp v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasAuditTime() => $_has(7);
  @$pb.TagNumber(12)
  void clearAuditTime() => clearField(12);
  @$pb.TagNumber(12)
  $34.Timestamp ensureAuditTime() => $_ensure(7);
}
