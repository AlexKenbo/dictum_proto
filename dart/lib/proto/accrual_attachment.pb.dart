...
class AccrualAttachment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccrualAttachment', createEmptyInstance: create)
    ...
    ..aOM<$4.Attachment>(4, _omitFieldNames ? '' : 'attachment', subBuilder: $4.Attachment.create)
  ...
  @$pb.TagNumber(4)
  $4.Attachment get attachment => $_getN(3);
  @$pb.TagNumber(4)
  set attachment($4.Attachment v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasAttachment() => $_has(3);
  @$pb.TagNumber(4)
  void clearAttachment() => clearField(4);
  @$pb.TagNumber(4)
  $4.Attachment ensureAttachment() => $_ensure(3);
}
