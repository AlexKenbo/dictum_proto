...
import 'attachment_type.pbenum.dart' as $39;
...
class Attachment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Attachment', createEmptyInstance: create)
    ...
    ..e<$39.AttachmentType>(4, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $39.AttachmentType.ATTACHMENT_TYPE_UNKNOWN, valueOf: $39.AttachmentType.valueOf, enumValues: $39.AttachmentType.values)
  ...
  @$pb.TagNumber(4)
  $39.AttachmentType get type => $_getN(3);
  @$pb.TagNumber(4)
  set type($39.AttachmentType v) { setField(4, v); }
  @$pb.TagNumber(4)
