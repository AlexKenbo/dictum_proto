...
class CurrencyRate extends $pb.GeneratedMessage {
  ...
  factory CurrencyRate.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CurrencyRate.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'CurrencyRate',
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'receiveCurrency')
    ..aOS(2, _omitFieldNames ? '' : 'giveCurrency')
    ..a<$core.double>(
        4, _omitFieldNames ? '' : 'purchasePrice', $pb.PbFieldType.OD)
    ..a<$core.double>(
        5, _omitFieldNames ? '' : 'sellingPrice', $pb.PbFieldType.OD)
    ..aOM<$53.Currency>(6, _omitFieldNames ? '' : 'receive',
        subBuilder: $53.Currency.create)
    ..aOM<$53.Currency>(8, _omitFieldNames ? '' : 'give',
        subBuilder: $53.Currency.create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  CurrencyRate copyWith(void Function(CurrencyRate) updates) =>
      super.copyWith((message) => updates(message as CurrencyRate))
          as CurrencyRate;
  ...
  static $pb.PbList<CurrencyRate> createRepeated() =>
      $pb.PbList<CurrencyRate>();
  @$core.pragma('dart2js:noInline')
  static CurrencyRate getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CurrencyRate>(create);
  static CurrencyRate? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get receiveCurrency => $_getSZ(0);
  @$pb.TagNumber(1)
  set receiveCurrency($core.String v) {
    $_setString(0, v);
  }
  ...
  @$pb.TagNumber(2)
  set giveCurrency($core.String v) {
    $_setString(1, v);
  }
  ...
  @$pb.TagNumber(4)
  set purchasePrice($core.double v) {
    $_setDouble(2, v);
  }
  ...
  @$pb.TagNumber(5)
  set sellingPrice($core.double v) {
    $_setDouble(3, v);
  }
  ...
  @$pb.TagNumber(6)
  $53.Currency get receive => $_getN(4);
  @$pb.TagNumber(6)
  set receive($53.Currency v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $53.Currency ensureReceive() => $_ensure(4);

  @$pb.TagNumber(8)
  $53.Currency get give => $_getN(5);
  @$pb.TagNumber(8)
  set give($53.Currency v) {
    setField(8, v);
  }
  ...
  @$pb.TagNumber(8)
  $53.Currency ensureGive() => $_ensure(5);
