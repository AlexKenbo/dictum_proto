...
class CurrencyRate extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(6)
  $43.Currency get receive => $_getN(4);
  @$pb.TagNumber(6)
  set receive($43.Currency v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasReceive() => $_has(4);
  @$pb.TagNumber(6)
  void clearReceive() => clearField(6);
  @$pb.TagNumber(6)
  $43.Currency ensureReceive() => $_ensure(4);

  @$pb.TagNumber(8)
  $43.Currency get give => $_getN(5);
  @$pb.TagNumber(8)
  set give($43.Currency v) { setField(8, v); }
  @$pb.TagNumber(8)
