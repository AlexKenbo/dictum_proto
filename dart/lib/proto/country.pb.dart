...
class Country extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Country', createEmptyInstance: create)
    ...
    ..aOM<$31.Timestamp>(4, _omitFieldNames ? '' : 'createTime', subBuilder: $31.Timestamp.create)
  ...
  @$pb.TagNumber(4)
  $31.Timestamp get createTime => $_getN(2);
  @$pb.TagNumber(4)
  set createTime($31.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCreateTime() => $_has(2);
  @$pb.TagNumber(4)
  void clearCreateTime() => clearField(4);
  @$pb.TagNumber(4)
  $31.Timestamp ensureCreateTime() => $_ensure(2);
}
