...
import 'side_deal_type.pbenum.dart' as $66;
...
class AccrualStatusTransition extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccrualStatusTransition', createEmptyInstance: create)
    ...
    ..e<$66.SideDealType>(5, _omitFieldNames ? '' : 'sideDeal', $pb.PbFieldType.OE, defaultOrMaker: $66.SideDealType.SIDE_DEAL_TYPE_UNKNOWN, valueOf: $66.SideDealType.valueOf, enumValues: $66.SideDealType.values)
  ...
  @$pb.TagNumber(5)
  $66.SideDealType get sideDeal => $_getN(4);
  @$pb.TagNumber(5)
  set sideDeal($66.SideDealType v) { setField(5, v); }
  @$pb.TagNumber(5)
