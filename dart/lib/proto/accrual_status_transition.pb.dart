...
import 'side_deal_type.pbenum.dart' as $61;
...
class AccrualStatusTransition extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccrualStatusTransition', createEmptyInstance: create)
    ...
    ..e<$55.PaymentType>(3, _omitFieldNames ? '' : 'paymentType', $pb.PbFieldType.OE, defaultOrMaker: $55.PaymentType.PAYMENT_TYPE_UNKNOWN, valueOf: $55.PaymentType.valueOf, enumValues: $55.PaymentType.values)
    ..aOB(4, _omitFieldNames ? '' : 'isExternalFlow')
    ..e<$61.SideDealType>(5, _omitFieldNames ? '' : 'sideDeal', $pb.PbFieldType.OE, defaultOrMaker: $61.SideDealType.SIDE_DEAL_TYPE_UNKNOWN, valueOf: $61.SideDealType.valueOf, enumValues: $61.SideDealType.values)
  ...
  @$pb.TagNumber(3)
  $55.PaymentType get paymentType => $_getN(2);
  @$pb.TagNumber(3)
  set paymentType($55.PaymentType v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(5)
  $61.SideDealType get sideDeal => $_getN(4);
  @$pb.TagNumber(5)
  set sideDeal($61.SideDealType v) { setField(5, v); }
  @$pb.TagNumber(5)
