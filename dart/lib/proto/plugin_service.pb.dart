...
class ListObjectSourcesResponse extends $pb.GeneratedMessage {
  factory ListObjectSourcesResponse({
    ...
    $core.Iterable<$33.ObjectSource>? sources,
  }) {
    final $result = create();
  ...
  @$pb.TagNumber(2)
  $core.List<$33.ObjectSource> get sources => $_getList(1);
}
...
class ListServicesResponse extends $pb.GeneratedMessage {
  factory ListServicesResponse({
    $core.String? resourceName,
    $core.Iterable<$34.Service>? services,
  }) {
    final $result = create();
    if (resourceName != null) {
      $result.resourceName = resourceName;
  ...
  @$pb.TagNumber(2)
  $core.List<$34.Service> get services => $_getList(1);
}
...
class ListServiceRunsResponse extends $pb.GeneratedMessage {
  factory ListServiceRunsResponse({
    $core.String? resourceName,
    $core.Iterable<$35.ServiceRun>? serviceRuns,
  ...
  @$pb.TagNumber(2)
  $core.List<$35.ServiceRun> get serviceRuns => $_getList(1);
