...
class Permission extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Permission', createEmptyInstance: create)
    ...
    ..aOM<$43.Action>(5, _omitFieldNames ? '' : 'action', subBuilder: $43.Action.create)
  ...
  @$pb.TagNumber(5)
  $43.Action get action => $_getN(4);
  @$pb.TagNumber(5)
  set action($43.Action v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasAction() => $_has(4);
  @$pb.TagNumber(5)
  void clearAction() => clearField(5);
  @$pb.TagNumber(5)
  $43.Action ensureAction() => $_ensure(4);
}
