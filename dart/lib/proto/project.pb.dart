...
class Project extends $pb.GeneratedMessage {
  factory Project({
    $core.int? projectId,
    $core.String? title,
    $31.Timestamp? startTime,
    $31.Timestamp? endTime,
  }) {
    final $result = create();
    if (projectId != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Project', createEmptyInstance: create)
    ...
    ..aOM<$31.Timestamp>(5, _omitFieldNames ? '' : 'startTime', subBuilder: $31.Timestamp.create)
    ..aOM<$31.Timestamp>(6, _omitFieldNames ? '' : 'endTime', subBuilder: $31.Timestamp.create)
  ...
  @$pb.TagNumber(5)
  $31.Timestamp get startTime => $_getN(2);
  @$pb.TagNumber(5)
  set startTime($31.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasStartTime() => $_has(2);
  @$pb.TagNumber(5)
  void clearStartTime() => clearField(5);
  @$pb.TagNumber(5)
  $31.Timestamp ensureStartTime() => $_ensure(2);

  @$pb.TagNumber(6)
  $31.Timestamp get endTime => $_getN(3);
  @$pb.TagNumber(6)
  set endTime($31.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasEndTime() => $_has(3);
  @$pb.TagNumber(6)
  void clearEndTime() => clearField(6);
  @$pb.TagNumber(6)
  $31.Timestamp ensureEndTime() => $_ensure(3);
}
