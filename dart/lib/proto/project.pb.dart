...
class Project extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$43.Timestamp>(5, _omitFieldNames ? '' : 'startTime',
        subBuilder: $43.Timestamp.create)
    ..aOM<$43.Timestamp>(6, _omitFieldNames ? '' : 'endTime',
        subBuilder: $43.Timestamp.create)
  ...
  @$pb.TagNumber(5)
  $43.Timestamp get startTime => $_getN(2);
  @$pb.TagNumber(5)
  set startTime($43.Timestamp v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $43.Timestamp ensureStartTime() => $_ensure(2);

  @$pb.TagNumber(6)
  $43.Timestamp get endTime => $_getN(3);
  @$pb.TagNumber(6)
  set endTime($43.Timestamp v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $43.Timestamp ensureEndTime() => $_ensure(3);
}
