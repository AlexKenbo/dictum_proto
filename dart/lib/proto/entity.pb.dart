...
import 'agent.pb.dart' as $43;
import 'country.pb.dart' as $42;
import 'entity_source.pb.dart' as $44;
import 'entity_type.pbenum.dart' as $45;
...
class Entity extends $pb.GeneratedMessage {
  factory Entity({
    ...
    $42.Country? country,
    $43.Agent? agent,
    $core.Iterable<$44.EntitySource>? sources,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Entity', createEmptyInstance: create)
    ...
    ..e<$45.EntityType>(4, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $45.EntityType.ENTITY_TYPE_UNKNOWN, valueOf: $45.EntityType.valueOf, enumValues: $45.EntityType.values)
    ...
    ..aOM<$41.TelegramUser>(21, _omitFieldNames ? '' : 'telegramUser', subBuilder: $41.TelegramUser.create)
    ..aOM<$42.Country>(23, _omitFieldNames ? '' : 'country', subBuilder: $42.Country.create)
    ..aOM<$43.Agent>(25, _omitFieldNames ? '' : 'agent', subBuilder: $43.Agent.create)
    ..pc<$44.EntitySource>(27, _omitFieldNames ? '' : 'sources', $pb.PbFieldType.PM, subBuilder: $44.EntitySource.create)
    ..a<$core.int>(28, _omitFieldNames ? '' : 'contactCreatorId', $pb.PbFieldType.O3)
    ..aOS(29, _omitFieldNames ? '' : 'aliasCode')
    ..aOM<$40.Timestamp>(30, _omitFieldNames ? '' : 'createTime', subBuilder: $40.Timestamp.create)
  ...
  @$pb.TagNumber(4)
  $45.EntityType get type => $_getN(3);
  @$pb.TagNumber(4)
  set type($45.EntityType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(21)
  $41.TelegramUser get telegramUser => $_getN(12);
  @$pb.TagNumber(21)
  set telegramUser($41.TelegramUser v) { setField(21, v); }
  @$pb.TagNumber(21)
  $core.bool hasTelegramUser() => $_has(12);
  @$pb.TagNumber(21)
  void clearTelegramUser() => clearField(21);
  @$pb.TagNumber(21)
  $41.TelegramUser ensureTelegramUser() => $_ensure(12);

  @$pb.TagNumber(23)
  $42.Country get country => $_getN(13);
  @$pb.TagNumber(23)
  set country($42.Country v) { setField(23, v); }
  @$pb.TagNumber(23)
  $core.bool hasCountry() => $_has(13);
  @$pb.TagNumber(23)
  void clearCountry() => clearField(23);
  @$pb.TagNumber(23)
  $42.Country ensureCountry() => $_ensure(13);

  @$pb.TagNumber(25)
  $43.Agent get agent => $_getN(14);
  @$pb.TagNumber(25)
  set agent($43.Agent v) { setField(25, v); }
  @$pb.TagNumber(25)
  $core.bool hasAgent() => $_has(14);
  @$pb.TagNumber(25)
  void clearAgent() => clearField(25);
  @$pb.TagNumber(25)
  $43.Agent ensureAgent() => $_ensure(14);

  @$pb.TagNumber(27)
  $core.List<$44.EntitySource> get sources => $_getList(15);
  ...
  @$pb.TagNumber(30)
  $40.Timestamp get createTime => $_getN(18);
  @$pb.TagNumber(30)
  set createTime($40.Timestamp v) { setField(30, v); }
  @$pb.TagNumber(30)
  $core.bool hasCreateTime() => $_has(18);
  @$pb.TagNumber(30)
  void clearCreateTime() => clearField(30);
  @$pb.TagNumber(30)
  $40.Timestamp ensureCreateTime() => $_ensure(18);
}
