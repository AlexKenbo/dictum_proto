...
import 'agent.pb.dart' as $38;
import 'country.pb.dart' as $37;
import 'entity_source.pb.dart' as $39;
import 'entity_type.pbenum.dart' as $40;
import 'telegram_user.pb.dart' as $36;
...
class Entity extends $pb.GeneratedMessage {
  factory Entity({
    ...
    $36.TelegramUser? telegramUser,
    $37.Country? country,
    $38.Agent? agent,
    $core.Iterable<$39.EntitySource>? sources,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Entity', createEmptyInstance: create)
    ...
    ..e<$40.EntityType>(4, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $40.EntityType.ENTITY_TYPE_UNKNOWN, valueOf: $40.EntityType.valueOf, enumValues: $40.EntityType.values)
    ...
    ..aOM<$36.TelegramUser>(21, _omitFieldNames ? '' : 'telegramUser', subBuilder: $36.TelegramUser.create)
    ..aOM<$37.Country>(23, _omitFieldNames ? '' : 'country', subBuilder: $37.Country.create)
    ..aOM<$38.Agent>(25, _omitFieldNames ? '' : 'agent', subBuilder: $38.Agent.create)
    ..pc<$39.EntitySource>(27, _omitFieldNames ? '' : 'sources', $pb.PbFieldType.PM, subBuilder: $39.EntitySource.create)
    ..a<$core.int>(28, _omitFieldNames ? '' : 'contactCreatorId', $pb.PbFieldType.O3)
    ..aOS(29, _omitFieldNames ? '' : 'aliasCode')
    ..aOM<$35.Timestamp>(30, _omitFieldNames ? '' : 'createTime', subBuilder: $35.Timestamp.create)
  ...
  @$pb.TagNumber(4)
  $40.EntityType get type => $_getN(3);
  @$pb.TagNumber(4)
  set type($40.EntityType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(21)
  $36.TelegramUser get telegramUser => $_getN(12);
  @$pb.TagNumber(21)
  set telegramUser($36.TelegramUser v) { setField(21, v); }
  @$pb.TagNumber(21)
  $core.bool hasTelegramUser() => $_has(12);
  @$pb.TagNumber(21)
  void clearTelegramUser() => clearField(21);
  @$pb.TagNumber(21)
  $36.TelegramUser ensureTelegramUser() => $_ensure(12);

  @$pb.TagNumber(23)
  $37.Country get country => $_getN(13);
  @$pb.TagNumber(23)
  set country($37.Country v) { setField(23, v); }
  @$pb.TagNumber(23)
  $core.bool hasCountry() => $_has(13);
  @$pb.TagNumber(23)
  void clearCountry() => clearField(23);
  @$pb.TagNumber(23)
  $37.Country ensureCountry() => $_ensure(13);

  @$pb.TagNumber(25)
  $38.Agent get agent => $_getN(14);
  @$pb.TagNumber(25)
  set agent($38.Agent v) { setField(25, v); }
  @$pb.TagNumber(25)
  $core.bool hasAgent() => $_has(14);
  @$pb.TagNumber(25)
  void clearAgent() => clearField(25);
  @$pb.TagNumber(25)
  $38.Agent ensureAgent() => $_ensure(14);

  @$pb.TagNumber(27)
  $core.List<$39.EntitySource> get sources => $_getList(15);
  ...
  @$pb.TagNumber(30)
  $35.Timestamp get createTime => $_getN(18);
  @$pb.TagNumber(30)
  set createTime($35.Timestamp v) { setField(30, v); }
  @$pb.TagNumber(30)
  $core.bool hasCreateTime() => $_has(18);
  @$pb.TagNumber(30)
  void clearCreateTime() => clearField(30);
  @$pb.TagNumber(30)
  $35.Timestamp ensureCreateTime() => $_ensure(18);
}
