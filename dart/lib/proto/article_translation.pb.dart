...
class ArticleTranslation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ArticleTranslation', createEmptyInstance: create)
    ...
    ..aOM<$65.Language>(6, _omitFieldNames ? '' : 'language', subBuilder: $65.Language.create)
  ...
  @$pb.TagNumber(6)
  $65.Language get language => $_getN(4);
  @$pb.TagNumber(6)
  set language($65.Language v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasLanguage() => $_has(4);
  @$pb.TagNumber(6)
  void clearLanguage() => clearField(6);
  @$pb.TagNumber(6)
  $65.Language ensureLanguage() => $_ensure(4);
}
