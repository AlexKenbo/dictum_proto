...
import 'plugin_owner_type.pbenum.dart' as $0;

class Plugin extends $pb.GeneratedMessage {
  factory Plugin({
    $core.int? pluginId,
    $core.String? name,
    $0.PluginOwnerType? ownerType,
    $core.String? scopes,
  }) {
    final $result = create();
    if (pluginId != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Plugin', createEmptyInstance: create)
    ...
    ..e<$0.PluginOwnerType>(3, _omitFieldNames ? '' : 'ownerType', $pb.PbFieldType.OE, defaultOrMaker: $0.PluginOwnerType.PLUGIN_OWNER_TYPE_UNKNOWN, valueOf: $0.PluginOwnerType.valueOf, enumValues: $0.PluginOwnerType.values)
  ...
  @$pb.TagNumber(3)
  $0.PluginOwnerType get ownerType => $_getN(2);
  @$pb.TagNumber(3)
  set ownerType($0.PluginOwnerType v) { setField(3, v); }
  @$pb.TagNumber(3)
