...
class AccrualAllocations extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccrualAllocations', createEmptyInstance: create)
    ..aOM<$19.Accrual>(1, _omitFieldNames ? '' : 'accrual', subBuilder: $19.Accrual.create)
  ...
  @$pb.TagNumber(1)
  $19.Accrual get accrual => $_getN(0);
  @$pb.TagNumber(1)
  set accrual($19.Accrual v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAccrual() => $_has(0);
  @$pb.TagNumber(1)
  void clearAccrual() => clearField(1);
  @$pb.TagNumber(1)
  $19.Accrual ensureAccrual() => $_ensure(0);
