...
import 'accrual_status_transition.pb.dart' as $62;
...
class ListAccrualStatusTransitionsResponse extends $pb.GeneratedMessage {
  factory ListAccrualStatusTransitionsResponse({
    $core.String? resourceName,
    $core.Iterable<$62.AccrualStatusTransition>? accrualStatusTransitions,
  }) {
    final $result = create();
    if (resourceName != null) {
      $result.resourceName = resourceName;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListAccrualStatusTransitionsResponse', createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..pc<$62.AccrualStatusTransition>(2, _omitFieldNames ? '' : 'accrualStatusTransitions', $pb.PbFieldType.PM, subBuilder: $62.AccrualStatusTransition.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$62.AccrualStatusTransition> get accrualStatusTransitions => $_getList(1);
}
