...
import 'currency_type.pbenum.dart' as $52;

class Currency extends $pb.GeneratedMessage {
  factory Currency({
    $core.String? code,
    $52.CurrencyType? type,
  }) {
    final $result = create();
    if (code != null) {
      $result.code = code;
  ...
  Currency._() : super();
  factory Currency.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Currency.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$52.CurrencyType>(2, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE,
        defaultOrMaker: $52.CurrencyType.CURRENCY_TYPE_UNKNOWN,
        valueOf: $52.CurrencyType.valueOf,
        enumValues: $52.CurrencyType.values)
  ...
  @$pb.TagNumber(2)
  $52.CurrencyType get type => $_getN(1);
  @$pb.TagNumber(2)
  set type($52.CurrencyType v) {
    setField(2, v);
  }
