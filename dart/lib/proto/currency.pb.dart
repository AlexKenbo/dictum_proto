...
class Currency extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Currency', createEmptyInstance: create)
    ...
    ..e<$52.CurrencyType>(2, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $52.CurrencyType.CURRENCY_TYPE_UNKNOWN, valueOf: $52.CurrencyType.valueOf, enumValues: $52.CurrencyType.values)
  ...
  @$pb.TagNumber(2)
  set type($52.CurrencyType v) { setField(2, v); }
  @$pb.TagNumber(2)
