...
class Position extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Position', createEmptyInstance: create)
    ...
    ..aOM<$21.Product>(9, _omitFieldNames ? '' : 'product', subBuilder: $21.Product.create)
    ..aOM<$19.Accrual>(12, _omitFieldNames ? '' : 'accrual', subBuilder: $19.Accrual.create)
  ...
  @$pb.TagNumber(9)
  $21.Product get product => $_getN(7);
  @$pb.TagNumber(9)
  set product($21.Product v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasProduct() => $_has(7);
  @$pb.TagNumber(9)
  void clearProduct() => clearField(9);
  @$pb.TagNumber(9)
  $21.Product ensureProduct() => $_ensure(7);

  @$pb.TagNumber(12)
  $19.Accrual get accrual => $_getN(8);
  @$pb.TagNumber(12)
  set accrual($19.Accrual v) { setField(12, v); }
  @$pb.TagNumber(12)
