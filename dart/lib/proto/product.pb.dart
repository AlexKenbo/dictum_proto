...
class Product extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Product', createEmptyInstance: create)
    ...
    ..aOM<$0.Entity>(4, _omitFieldNames ? '' : 'entity', subBuilder: $0.Entity.create)
  ...
  @$pb.TagNumber(4)
  $0.Entity get entity => $_getN(3);
  @$pb.TagNumber(4)
  set entity($0.Entity v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasEntity() => $_has(3);
  @$pb.TagNumber(4)
  void clearEntity() => clearField(4);
  @$pb.TagNumber(4)
  $0.Entity ensureEntity() => $_ensure(3);
}
