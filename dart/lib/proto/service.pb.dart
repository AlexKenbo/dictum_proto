...
import 'plugin_owner_type.pbenum.dart' as $4;
...
class Service extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Service', createEmptyInstance: create)
    ...
    ..e<$4.PluginOwnerType>(4, _omitFieldNames ? '' : 'ownerType', $pb.PbFieldType.OE, defaultOrMaker: $4.PluginOwnerType.PLUGIN_OWNER_TYPE_UNKNOWN, valueOf: $4.PluginOwnerType.valueOf, enumValues: $4.PluginOwnerType.values)
    ...
    ..aOM<$3.Timestamp>(19, _omitFieldNames ? '' : 'syncTime', subBuilder: $3.Timestamp.create)
  ...
  @$pb.TagNumber(4)
  $4.PluginOwnerType get ownerType => $_getN(3);
  @$pb.TagNumber(4)
  set ownerType($4.PluginOwnerType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(14)
  $0.Plugin ensurePlugin() => $_ensure(8);

  @$pb.TagNumber(16)
  $1.Entity get entity => $_getN(9);
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(16)
  $1.Entity ensureEntity() => $_ensure(9);

  @$pb.TagNumber(18)
  $2.Account get account => $_getN(10);
  @$pb.TagNumber(18)
  ...
  @$pb.TagNumber(18)
  $2.Account ensureAccount() => $_ensure(10);

  @$pb.TagNumber(19)
  $3.Timestamp get syncTime => $_getN(11);
  @$pb.TagNumber(19)
  set syncTime($3.Timestamp v) { setField(19, v); }
  @$pb.TagNumber(19)
  $core.bool hasSyncTime() => $_has(11);
  @$pb.TagNumber(19)
  void clearSyncTime() => clearField(19);
  @$pb.TagNumber(19)
  $3.Timestamp ensureSyncTime() => $_ensure(11);
}
