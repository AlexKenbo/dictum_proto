...
import 'plugin.pb.dart' as $64;
import 'plugin_owner_type.pbenum.dart' as $63;
...
class Service extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Service', createEmptyInstance: create)
    ...
    ..e<$63.PluginOwnerType>(4, _omitFieldNames ? '' : 'ownerType', $pb.PbFieldType.OE, defaultOrMaker: $63.PluginOwnerType.PLUGIN_OWNER_TYPE_UNKNOWN, valueOf: $63.PluginOwnerType.valueOf, enumValues: $63.PluginOwnerType.values)
    ...
    ..aOM<$64.Plugin>(14, _omitFieldNames ? '' : 'plugin', subBuilder: $64.Plugin.create)
  ...
  @$pb.TagNumber(4)
  $63.PluginOwnerType get ownerType => $_getN(3);
  @$pb.TagNumber(4)
  set ownerType($63.PluginOwnerType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(14)
  $64.Plugin get plugin => $_getN(8);
  @$pb.TagNumber(14)
  set plugin($64.Plugin v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasPlugin() => $_has(8);
  @$pb.TagNumber(14)
  void clearPlugin() => clearField(14);
  @$pb.TagNumber(14)
  $64.Plugin ensurePlugin() => $_ensure(8);
