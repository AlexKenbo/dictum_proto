...
const Accrual$json = {
  ...
  '2': [
    ...
    {'1': 'confirmation_canceled', '3': 71, '4': 1, '5': 8, '10': 'confirmationCanceled'},
  ],
};
...
final $typed_data.Uint8List accrualDescriptor = $convert.base64Decode(
    ...
    'X2NvbW1lbnRzGEYgASgIUgtoYXNDb21tZW50cxIzChVjb25maXJtYXRpb25fY2FuY2VsZWQYRy'
    'ABKAhSFGNvbmZpcm1hdGlvbkNhbmNlbGVk');
