...
class Allocation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Allocation', createEmptyInstance: create)
    ...
    ..aOM<$31.Timestamp>(14, _omitFieldNames ? '' : 'createTime', subBuilder: $31.Timestamp.create)
  ...
  @$pb.TagNumber(13)
  $22.Transfer get transfer => $_getN(9);
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(13)
  $22.Transfer ensureTransfer() => $_ensure(9);

  @$pb.TagNumber(14)
  $31.Timestamp get createTime => $_getN(10);
  @$pb.TagNumber(14)
  set createTime($31.Timestamp v) { setField(14, v); }
  @$pb.TagNumber(14)
