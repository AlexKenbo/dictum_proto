...
import 'permission.pb.dart' as $20;
...
class FinEventClient extends $grpc.Client {
  static final _$createPermission = $grpc.ClientMethod<$20.Permission, $20.Permission>(
      '/FinEvent/CreatePermission',
      ($20.Permission value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $20.Permission.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$20.Permission> createPermission($20.Permission request, {$grpc.CallOptions? options}) {
...
abstract class FinEventServiceBase extends $grpc.Service {
  ...
  FinEventServiceBase() {
    $addMethod($grpc.ServiceMethod<$20.Permission, $20.Permission>(
        'CreatePermission',
  ...
  $async.Future<$20.Permission> createPermission_Pre($grpc.ServiceCall call, $async.Future<$20.Permission> request) async {
  ...
  $async.Future<$20.Permission> createPermission($grpc.ServiceCall call, $20.Permission request);
