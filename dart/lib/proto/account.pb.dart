...
class Account extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Account', createEmptyInstance: create)
    ...
    ..e<$44.AccountType>(6, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $44.AccountType.ACCOUNT_TYPE_UNKNOWN, valueOf: $44.AccountType.valueOf, enumValues: $44.AccountType.values)
    ...
    ..aOM<$42.Currency>(17, _omitFieldNames ? '' : 'currency', subBuilder: $42.Currency.create)
    ...
    ..aOM<$33.Timestamp>(24, _omitFieldNames ? '' : 'createTime', subBuilder: $33.Timestamp.create)
  ...
  @$pb.TagNumber(6)
  $44.AccountType get type => $_getN(5);
  @$pb.TagNumber(6)
  set type($44.AccountType v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(17)
  $42.Currency get currency => $_getN(12);
  @$pb.TagNumber(17)
  set currency($42.Currency v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasCurrency() => $_has(12);
  @$pb.TagNumber(17)
  void clearCurrency() => clearField(17);
  @$pb.TagNumber(17)
  $42.Currency ensureCurrency() => $_ensure(12);

  @$pb.TagNumber(19)
  $43.Fi get fi => $_getN(13);
  @$pb.TagNumber(19)
  set fi($43.Fi v) { setField(19, v); }
  @$pb.TagNumber(19)
  $core.bool hasFi() => $_has(13);
  @$pb.TagNumber(19)
  void clearFi() => clearField(19);
  @$pb.TagNumber(19)
  $43.Fi ensureFi() => $_ensure(13);
  ...
  @$pb.TagNumber(24)
  $33.Timestamp get createTime => $_getN(16);
  @$pb.TagNumber(24)
  set createTime($33.Timestamp v) { setField(24, v); }
  @$pb.TagNumber(24)
  $core.bool hasCreateTime() => $_has(16);
  @$pb.TagNumber(24)
  void clearCreateTime() => clearField(24);
  @$pb.TagNumber(24)
  $33.Timestamp ensureCreateTime() => $_ensure(16);
}
