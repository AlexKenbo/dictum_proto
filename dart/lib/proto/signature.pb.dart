...
class Signature extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Signature', createEmptyInstance: create)
    ...
    ..aOM<$33.Timestamp>(5, _omitFieldNames ? '' : 'createTime', subBuilder: $33.Timestamp.create)
    ..aOS(6, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$41.Action>(7, _omitFieldNames ? '' : 'action', subBuilder: $41.Action.create)
  ...
  @$pb.TagNumber(5)
  $33.Timestamp get createTime => $_getN(4);
  @$pb.TagNumber(5)
  set createTime($33.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasCreateTime() => $_has(4);
  @$pb.TagNumber(5)
  void clearCreateTime() => clearField(5);
  @$pb.TagNumber(5)
  $33.Timestamp ensureCreateTime() => $_ensure(4);
  ...
  @$pb.TagNumber(7)
  $41.Action get action => $_getN(6);
  @$pb.TagNumber(7)
  set action($41.Action v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasAction() => $_has(6);
  @$pb.TagNumber(7)
  void clearAction() => clearField(7);
  @$pb.TagNumber(7)
  $41.Action ensureAction() => $_ensure(6);
