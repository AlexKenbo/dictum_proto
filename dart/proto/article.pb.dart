...
import 'article_group.pbenum.dart' as $43;
import 'direction.pbenum.dart' as $44;
...
class Article extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Article', createEmptyInstance: create)
    ...
    ..e<$43.ArticleGroup>(8, _omitFieldNames ? '' : 'articleGroup', $pb.PbFieldType.OE, defaultOrMaker: $43.ArticleGroup.ARTICLE_GROUP_UNKNOWN, valueOf: $43.ArticleGroup.valueOf, enumValues: $43.ArticleGroup.values)
    ..e<$44.Direction>(9, _omitFieldNames ? '' : 'direction', $pb.PbFieldType.OE, defaultOrMaker: $44.Direction.DIRECTION_UNKNOWN, valueOf: $44.Direction.valueOf, enumValues: $44.Direction.values)
  ...
  @$pb.TagNumber(8)
  $43.ArticleGroup get articleGroup => $_getN(7);
  @$pb.TagNumber(8)
  set articleGroup($43.ArticleGroup v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  $44.Direction get direction => $_getN(8);
  @$pb.TagNumber(9)
  set direction($44.Direction v) { setField(9, v); }
  @$pb.TagNumber(9)
