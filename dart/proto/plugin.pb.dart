...
class Plugin extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Plugin', createEmptyInstance: create)
    ...
    ..e<$52.PluginOwnerType>(3, _omitFieldNames ? '' : 'ownerType', $pb.PbFieldType.OE, defaultOrMaker: $52.PluginOwnerType.PLUGIN_OWNER_TYPE_UNKNOWN, valueOf: $52.PluginOwnerType.valueOf, enumValues: $52.PluginOwnerType.values)
  ...
  @$pb.TagNumber(3)
  $52.PluginOwnerType get ownerType => $_getN(2);
  @$pb.TagNumber(3)
  set ownerType($52.PluginOwnerType v) { setField(3, v); }
  @$pb.TagNumber(3)
