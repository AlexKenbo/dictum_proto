...
class AccrualMirrorState extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccrualMirrorState', createEmptyInstance: create)
    ...
    ..e<$50.PaymentType>(2, _omitFieldNames ? '' : 'paymentType', $pb.PbFieldType.OE, defaultOrMaker: $50.PaymentType.PAYMENT_TYPE_UNKNOWN, valueOf: $50.PaymentType.valueOf, enumValues: $50.PaymentType.values)
  ...
  @$pb.TagNumber(2)
  $50.PaymentType get paymentType => $_getN(1);
  @$pb.TagNumber(2)
  set paymentType($50.PaymentType v) { setField(2, v); }
  @$pb.TagNumber(2)
