...
import 'plugin.pb.dart' as $53;
import 'plugin_owner_type.pbenum.dart' as $52;
...
class Service extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Service', createEmptyInstance: create)
    ...
    ..e<$52.PluginOwnerType>(4, _omitFieldNames ? '' : 'ownerType', $pb.PbFieldType.OE, defaultOrMaker: $52.PluginOwnerType.PLUGIN_OWNER_TYPE_UNKNOWN, valueOf: $52.PluginOwnerType.valueOf, enumValues: $52.PluginOwnerType.values)
    ...
    ..aOM<$53.Plugin>(14, _omitFieldNames ? '' : 'plugin', subBuilder: $53.Plugin.create)
  ...
  @$pb.TagNumber(4)
  $52.PluginOwnerType get ownerType => $_getN(3);
  @$pb.TagNumber(4)
  set ownerType($52.PluginOwnerType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(14)
  $53.Plugin get plugin => $_getN(9);
  @$pb.TagNumber(14)
  set plugin($53.Plugin v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasPlugin() => $_has(9);
  @$pb.TagNumber(14)
  void clearPlugin() => clearField(14);
  @$pb.TagNumber(14)
  $53.Plugin ensurePlugin() => $_ensure(9);
