...
import 'transfers_aggregate.pb.dart' as $23;
...
class FinEventClient extends $grpc.Client {
  ...
  static final _$updateTransfer = $grpc.ClientMethod<$22.Transfer, $22.Transfer>(
      ...
      ($22.Transfer value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $22.Transfer.fromBuffer(value));
  static final _$aggregateTransfers = $grpc.ClientMethod<$0.AggregateRequest, $23.TransfersAggregate>(
      '/FinEvent/AggregateTransfers',
      ($0.AggregateRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $23.TransfersAggregate.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$23.TransfersAggregate> aggregateTransfers($0.AggregateRequest request, {$grpc.CallOptions? options}) {
...
abstract class FinEventServiceBase extends $grpc.Service {
  ...
  FinEventServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$22.Transfer, $22.Transfer>(
        ...
        ($core.List<$core.int> value) => $22.Transfer.fromBuffer(value),
        ($22.Transfer value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.AggregateRequest, $23.TransfersAggregate>(
        'AggregateTransfers',
        aggregateTransfers_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.AggregateRequest.fromBuffer(value),
        ($23.TransfersAggregate value) => value.writeToBuffer()));
  ...
  $async.Future<$23.TransfersAggregate> aggregateTransfers_Pre($grpc.ServiceCall call, $async.Future<$0.AggregateRequest> request) async {
  ...
  $async.Future<$23.TransfersAggregate> aggregateTransfers($grpc.ServiceCall call, $0.AggregateRequest request);
