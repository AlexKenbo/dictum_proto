...
import 'action_type.pbenum.dart' as $29;
...
class Subscription extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Subscription', createEmptyInstance: create)
    ...
    ..e<$29.ActionType>(3, _omitFieldNames ? '' : 'actionType', $pb.PbFieldType.OE, defaultOrMaker: $29.ActionType.ACTION_TYPE_UNKNOWN, valueOf: $29.ActionType.valueOf, enumValues: $29.ActionType.values)
  ...
  @$pb.TagNumber(3)
  $29.ActionType get actionType => $_getN(1);
  @$pb.TagNumber(3)
  set actionType($29.ActionType v) { setField(3, v); }
  @$pb.TagNumber(3)
