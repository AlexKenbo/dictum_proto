...
class ListCountriesResponse extends $pb.GeneratedMessage {
  factory ListCountriesResponse({
    $core.String? resourceName,
    $core.Iterable<$32.Country>? countries,
  }) {
    final $result = create();
    if (resourceName != null) {
      $result.resourceName = resourceName;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListCountriesResponse', createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..pc<$32.Country>(2, _omitFieldNames ? '' : 'countries', $pb.PbFieldType.PM, subBuilder: $32.Country.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$32.Country> get countries => $_getList(1);
}
