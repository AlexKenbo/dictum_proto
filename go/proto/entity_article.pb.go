...
var file_proto_entity_article_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x42, 0x26, 0x5a, 0x24, 0x67, 0x69, 0x74, 0x68,
...
var file_proto_entity_article_proto_goTypes = []any{
...
func file_proto_entity_article_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_entity_article_proto_msgTypes[0].Exporter = func(v any, i int) any {
