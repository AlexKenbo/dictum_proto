...
type Currency struct {
	...
	Type CurrencyType `protobuf:"varint,2,opt,name=type,proto3,enum=CurrencyType" json:"type,omitempty"`
}
...
func (x *Currency) GetType() CurrencyType {
	if x != nil {
		return x.Type
	}
...
var file_proto_currency_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x41, 0x0a, 0x08, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x12, 0x12, 0x0a,
	0x04, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x63, 0x6f, 0x64,
	0x65, 0x12, 0x21, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32,
	0x0d, 0x2e, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04,
	0x74, 0x79, 0x70, 0x65, 0x42, 0x26, 0x5a, 0x24, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_proto_currency_proto_depIdxs = []int32{
	1, // 0: Currency.type:type_name -> CurrencyType
...
func file_proto_currency_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_currency_proto_msgTypes[0].Exporter = func(v any, i int) any {
