...
type PaymentServiceClient interface {
	...
	BatchProcessPayment(ctx context.Context, in *BatchProcessPaymentRequest, opts ...grpc.CallOption) (PaymentService_BatchProcessPaymentClient, error)
...
func (c *paymentServiceClient) BatchProcessPayment(ctx context.Context, in *BatchProcessPaymentRequest, opts ...grpc.CallOption) (PaymentService_BatchProcessPaymentClient, error) {
	stream, err := c.cc.NewStream(ctx, &PaymentService_ServiceDesc.Streams[0], "/payment.PaymentService/BatchProcessPayment", opts...)
	if err != nil {
		return nil, err
	}
	x := &paymentServiceBatchProcessPaymentClient{stream}
...
type PaymentService_BatchProcessPaymentClient interface {
	Recv() (*ProcessPaymentResponse, error)
	grpc.ClientStream
}

type paymentServiceBatchProcessPaymentClient struct {
	grpc.ClientStream
}

func (x *paymentServiceBatchProcessPaymentClient) Recv() (*ProcessPaymentResponse, error) {
	m := new(ProcessPaymentResponse)
...
func (c *paymentServiceClient) CheckTransactionStatus(ctx context.Context, in *CheckTransactionStatusRequest, opts ...grpc.CallOption) (*CheckTransactionStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/payment.PaymentService/CheckTransactionStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paymentServiceClient) EstimateEnergy(ctx context.Context, in *EstimateEnergyRequest, opts ...grpc.CallOption) (*EstimateEnergyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/payment.PaymentService/EstimateEnergy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paymentServiceClient) WaitTransactionConfirmation(ctx context.Context, in *WaitTransactionConfirmationRequest, opts ...grpc.CallOption) (*WaitTransactionConfirmationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/payment.PaymentService/WaitTransactionConfirmation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PaymentServiceServer interface {
	...
	// Process a batch of payments
	BatchProcessPayment(*BatchProcessPaymentRequest, PaymentService_BatchProcessPaymentServer) error
	// Check the status of a transaction on the Tron network
...
func (UnimplementedPaymentServiceServer) BatchProcessPayment(*BatchProcessPaymentRequest, PaymentService_BatchProcessPaymentServer) error {
...
func _PaymentService_BatchProcessPayment_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(PaymentServiceServer).BatchProcessPayment(m, &paymentServiceBatchProcessPaymentServer{stream})
}

type PaymentService_BatchProcessPaymentServer interface {
	Send(*ProcessPaymentResponse) error
	grpc.ServerStream
}

type paymentServiceBatchProcessPaymentServer struct {
	grpc.ServerStream
}

func (x *paymentServiceBatchProcessPaymentServer) Send(m *ProcessPaymentResponse) error {
...
func _PaymentService_CheckTransactionStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/payment.PaymentService/CheckTransactionStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PaymentService_EstimateEnergy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/payment.PaymentService/EstimateEnergy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PaymentService_WaitTransactionConfirmation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/payment.PaymentService/WaitTransactionConfirmation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
