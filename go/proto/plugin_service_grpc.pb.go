...
func (c *pluginServiceClient) DeleteObjectSource(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/PluginService/DeleteObjectSource", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pluginServiceClient) RunService(ctx context.Context, in *RunServiceRequest, opts ...grpc.CallOption) (*ServiceRun, error) {
	out := new(ServiceRun)
	err := c.cc.Invoke(ctx, "/PluginService/RunService", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PluginService_DeleteObjectSource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/PluginService/DeleteObjectSource",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PluginService_RunService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/PluginService/RunService",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
