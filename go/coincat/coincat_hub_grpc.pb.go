...
// UnimplementedCoincatHubServer must be embedded to have
...
func (UnimplementedCoincatHubServer) testEmbeddedByValue()                    {}
...
func RegisterCoincatHubServer(s grpc.ServiceRegistrar, srv CoincatHubServer) {
	// If the following call pancis, it indicates UnimplementedCoincatHubServer was
