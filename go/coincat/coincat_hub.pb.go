...
var file_coincat_coincat_hub_proto_goTypes = []any{
...
func file_coincat_coincat_hub_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_coincat_coincat_hub_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_coincat_coincat_hub_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_coincat_coincat_hub_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_coincat_coincat_hub_proto_msgTypes[3].Exporter = func(v any, i int) any {
