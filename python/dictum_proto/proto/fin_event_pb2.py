...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_FINEVENT'].methods_by_name['BatchInsertPosition']._loaded_options = None
  _globals['_FINEVENT'].methods_by_name['BatchInsertPosition']._serialized_options = b'\202\323\344\223\002[\"\r/v1/positions:\017batch_positionsZ9\"&/v1/{resource_name=events/*}/positions:\017batch_positions'
